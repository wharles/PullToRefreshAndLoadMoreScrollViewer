...
namespace PullToRefreshAndLoadMoreScrollViewer.Controls
{
    public sealed class PullToRefreshScrollViewer : ContentControl
    {
        ...
        public static readonly DependencyProperty LoadMoreCommandProperty = DependencyProperty.Register("LoadMoreCommand", typeof(ICommand), typeof(PullToRefreshScrollViewer), new PropertyMetadata(null));
        ...
        /// <summary>
        /// when scroll roll in to end of view,loading more data
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ScrollViewer_ViewChanged(object sender, ScrollViewerViewChangedEventArgs e)
        {
            ...
            if (LoadMoreCommand != null && LoadMoreCommand.CanExecute(++offset))
            {
                double progress = control.VerticalOffset / control.ScrollableHeight;
                if (progress > 0.9 && !e.IsIntermediate)
                {
                    _isBusy = true;
                    LoadMoreCommand.Execute(++offset);
                    _isBusy = false;
                }
            }
        }
